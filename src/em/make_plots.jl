...
function generate_PPC(S,trial)
    ...
    # get mean trajectory
    mean_xhat, mean_yhat  = NeSS.generate_dlds_trials(S.mdl.A, S.mdl.B, S.mdl.Q,
                                            S.mdl.C, S.mdl.R, 
                                            S.mdl.B0, S.mdl.P0,
...
function report_R2(S)
    ...
    test_white_loglik = NeSS.test_loglik(S);
