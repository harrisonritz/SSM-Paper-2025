function plot_clusters_seperate(t,x,y,pcorr_pos, pcorr_neg)
...
plot(t(pcorr_pos<.025), nanmean(x(:,pcorr_pos<.025)), 'ob',  'LineWidth',1.5,'MarkerSize', 10)
plot(t(pcorr_neg<.025), nanmean(y(:,pcorr_neg<.025)), 'ob',  'LineWidth',1.5,'MarkerSize', 10)
